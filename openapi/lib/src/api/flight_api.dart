...
class FlightApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [FlightBookingEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlightBookingEntity>> flightControllerCreateFlightBookingV1({ 
    required CreateFlightBookingDTO createFlightBookingDTO,
    ...
    final _path = r'/v1/flight/booking';
    ...
    try {
      const _type = FullType(CreateFlightBookingDTO);
      _bodyData = _serializers.serialize(createFlightBookingDTO, specifiedType: _type);
    ...
    FlightBookingEntity? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FlightBookingEntity),
      ) as FlightBookingEntity;
    ...
    return Response<FlightBookingEntity>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [bookingId] - ID of the booking to delete
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FlightControllerDeleteFlightBookingV1200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlightControllerDeleteFlightBookingV1200Response>> flightControllerDeleteFlightBookingV1({ 
    ...
    final _path = r'/v1/flight/booking/{bookingId}'.replaceAll('{' r'bookingId' '}', encodeQueryParameter(_serializers, bookingId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    FlightControllerDeleteFlightBookingV1200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FlightControllerDeleteFlightBookingV1200Response),
      ) as FlightControllerDeleteFlightBookingV1200Response;
    ...
    return Response<FlightControllerDeleteFlightBookingV1200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [FlightBookingEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlightBookingEntity>> flightControllerGetFlightBookingV1({ 
    required String bookingId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<FlightBookingEntity>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<FlightBookingEntity>>> flightControllerGetFlightBookingsByFlightIdV1({ 
    ...
    final _path = r'/v1/flight/booking/flight/{flightId}'.replaceAll('{' r'flightId' '}', encodeQueryParameter(_serializers, flightId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<FlightBookingEntity>? _responseData;
    ...
    return Response<BuiltList<FlightBookingEntity>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [faFlightId] - FlightAware flight ID to fetch a specific flight. Use this after searching for flights to get details of a selected flight.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<FlightResponseEntity>> flightControllerGetFlightV1({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (faFlightId != null) r'faFlightId': encodeQueryParameter(_serializers, faFlightId, const FullType(String)),
    };
  ...
  /// * [icao] - ICAO flight number
  /// * [timezone] - The timezone from which the request is being made.
  /// * [date] - Flight date (ISO format). Filters flights by date if provided
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FlightSearchResponseEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlightSearchResponseEntity>> flightControllerSearchFlightsV1({ 
    required String iata,
    required String icao,
    required String timezone,
    String? date,
    ...
    final _path = r'/v1/flight/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    FlightSearchResponseEntity? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FlightSearchResponseEntity),
      ) as FlightSearchResponseEntity;
    ...
    return Response<FlightSearchResponseEntity>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [FlightBookingEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlightBookingEntity>> flightControllerUpdateFlightBookingV1({ 
    required String bookingId,
    required UpdateFlightBookingDTO updateFlightBookingDTO,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateFlightBookingDTO);
      _bodyData = _serializers.serialize(updateFlightBookingDTO, specifiedType: _type);
