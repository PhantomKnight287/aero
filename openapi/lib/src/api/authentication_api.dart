...
class AuthenticationApi {
  ...
  Future<Response<UserEntity>> authControllerGetCurrentUserV1({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LoginEntity>> authControllerLoginV1({ 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RegisterEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RegisterEntity>> authControllerRegisterV1({ 
    ...
    RegisterEntity? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RegisterEntity),
      ) as RegisterEntity;
    ...
    return Response<RegisterEntity>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
