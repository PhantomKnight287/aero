...
class FlightsApi {
  ...
  const FlightsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AirlineEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AirlineEntity>> flightsControllerGetAirlineV1({ 
    required GetAirlineDTO getAirlineDTO,
    ...
    final _path = r'/v1/flights/airline';
    ...
    try {
      const _type = FullType(GetAirlineDTO);
      _bodyData = _serializers.serialize(getAirlineDTO, specifiedType: _type);
    ...
    AirlineEntity? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AirlineEntity),
      ) as AirlineEntity;
  ...
  /// * [date] - Flight date in ISO format
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FlightsResponseEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlightsResponseEntity>> flightsControllerGetFlightsV1({ 
    ...
    FlightsResponseEntity? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FlightsResponseEntity),
      ) as FlightsResponseEntity;
    ...
    return Response<FlightsResponseEntity>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
